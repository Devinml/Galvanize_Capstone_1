...
if __name__ == '__main__':
    ...
    data_path = 'data/cleaned_data_29.csv'
    df_29 = pd.read_csv(dir_Galv + dir_repo + data_path)
    data_path = 'data/cleaned_data.csv'
    df = pd.read_csv(dir_Galv + dir_repo + data_path)
    data_path = 'data/cleaned_data_275.csv'
    df_275 = pd.read_csv(dir_Galv + dir_repo + data_path)
